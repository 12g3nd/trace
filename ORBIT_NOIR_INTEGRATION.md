...
- Three icon-only launchers use the supplied LocalSend, ChatGPT, and Claude vectors to open the locally installed applications without background process-status polling.
